...
_0x0:
	...
	.DB  0x20,0x48,0x6F,0x73,0x65,0x69,0x6E,0x20
	.DB  0x41,0x73,0x68,0x6F,0x6F,0x72,0x69,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0026 // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=In Bit2=Out Bit1=Out Bit0=Out
; 0000 0027 DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (0<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(247)
	OUT  0x1A,R30
; 0000 0028 // State: Bit7=0 Bit6=0 Bit5=0 Bit4=0 Bit3=T Bit2=0 Bit1=0 Bit0=0
...
; 0000 009A       /*if (col==16) {
; 0000 009B         col =0;
; 0000 009C         row = row == 0 ? 1 : 0 ;
; 0000 009D       }
; 0000 009E       lcd_gotoxy(col,row);
; 0000 009F       */
; 0000 00A0 
; 0000 00A1       lcd_putsf("Mohammad Hosein Ashoori");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
