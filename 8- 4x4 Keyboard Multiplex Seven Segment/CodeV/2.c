...
unsigned char keyboard(void){
        PORTA = 0b01110000;
        if (PINA.1 == 0)return 1;
        if (PINA.2 == 0)return 4;
        if (PINA.3 == 0)return 7;
        PORTA = 0b10110000; 
        if (PINA.0 == 0)return 0;
        if (PINA.1 == 0)return 2;
        if (PINA.2 == 0)return 5;
        if (PINA.3 == 0)return 8;                      
        PORTA = 0b11010000;
        if (PINA.1 == 0)return 3;
        if (PINA.2 == 0)return 6;
        if (PINA.3 == 0)return 9;                      
        else {    
        PORTB = 0xf0;
        return 20;
    }
