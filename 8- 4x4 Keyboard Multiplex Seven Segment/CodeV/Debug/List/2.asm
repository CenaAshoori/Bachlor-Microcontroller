...
; 0000 002D unsigned char keyboard(void){
_keyboard:
; .FSTART _keyboard
; 0000 002E         PORTA = 0b01110000;
	LDI  R30,LOW(112)
	OUT  0x1B,R30
; 0000 002F         if (PINA.1 == 0)return 1;
	SBIC 0x19,1
	RJMP _0x7
	LDI  R30,LOW(1)
	RET
; 0000 0030         if (PINA.2 == 0)return 4;
_0x7:
	SBIC 0x19,2
	RJMP _0x8
	LDI  R30,LOW(4)
	RET
; 0000 0031         if (PINA.3 == 0)return 7;
_0x8:
	SBIC 0x19,3
	RJMP _0x9
	LDI  R30,LOW(7)
	RET
; 0000 0032         PORTA = 0b10110000;
_0x9:
	LDI  R30,LOW(176)
	OUT  0x1B,R30
; 0000 0033         if (PINA.0 == 0)return 0;
	SBIC 0x19,0
	RJMP _0xA
	LDI  R30,LOW(0)
	RET
; 0000 0034         if (PINA.1 == 0)return 2;
_0xA:
	SBIC 0x19,1
	RJMP _0xB
	LDI  R30,LOW(2)
	RET
; 0000 0035         if (PINA.2 == 0)return 5;
_0xB:
	SBIC 0x19,2
	RJMP _0xC
	LDI  R30,LOW(5)
	RET
; 0000 0036         if (PINA.3 == 0)return 8;
_0xC:
	SBIC 0x19,3
	RJMP _0xD
	LDI  R30,LOW(8)
	RET
; 0000 0037         PORTA = 0b11010000;
_0xD:
	LDI  R30,LOW(208)
	OUT  0x1B,R30
; 0000 0038         if (PINA.1 == 0)return 3;
	SBIC 0x19,1
	RJMP _0xE
	LDI  R30,LOW(3)
	RET
; 0000 0039         if (PINA.2 == 0)return 6;
_0xE:
	SBIC 0x19,2
	RJMP _0xF
	LDI  R30,LOW(6)
	RET
; 0000 003A         if (PINA.3 == 0)return 9;
_0xF:
	SBIC 0x19,3
	RJMP _0x10
	LDI  R30,LOW(9)
...
; 0000 0045 unsigned char j,key=20;
; 0000 0046 unsigned int i=0,i1;
; 0000 0047 // Input/Output Ports initialization
; 0000 0048 // Port A initialization
; 0000 0049 // Function: Bit7=In Bit6=Out Bit5=Out Bit4=Out Bit3=Out Bit2=In Bit1=In Bit0=In
; 0000 004A DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
;	j -> R17
;	key -> R16
;	i -> R18,R19
;	i1 -> R20,R21
	...
	LDI  R30,LOW(240)
	OUT  0x1A,R30
; 0000 004B // State: Bit7=T Bit6=0 Bit5=0 Bit4=0 Bit3=0 Bit2=T Bit1=T Bit0=T
...
; 0000 0056 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
...
; 0000 009E ACSR=(1<<ACD) | (0<<ACBG) | (0<<ACO) | (0<<ACI) | (0<<ACIE) | (0<<ACIC) | (0<<ACIS1) | (0<<ACIS0);
	LDI  R30,LOW(128)
	OUT  0x8,R30
; 0000 009F SFIOR=(0<<ACME);
	LDI  R30,LOW(0)
	OUT  0x30,R30
; 0000 00A0 
; 0000 00A1 // ADC initialization
; 0000 00A2 // ADC disabled
; 0000 00A3 ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 00A4 
...
; 0000 00AC 
; 0000 00AD 
; 0000 00AE PORTD=0x0f;
	LDI  R30,LOW(15)
	OUT  0x12,R30
; 0000 00AF PORTA=0xf0;
	LDI  R30,LOW(240)
	OUT  0x1B,R30
; 0000 00B0 while(1){
_0x12:
; 0000 00B1 
; 0000 00B2     key=keyboard();
	RCALL _keyboard
	MOV  R16,R30
; 0000 00B3     if(key==11)key=0;
	CPI  R16,11
	BRNE _0x15
	LDI  R16,LOW(0)
; 0000 00B4     if(key == 10){
_0x15:
	CPI  R16,10
	BRNE _0x16
; 0000 00B5         register unsigned char x;
; 0000 00B6         for (x =0;x<4;x++)
	SBIW R28,1
;	x -> Y+0
	LDI  R30,LOW(0)
	ST   Y,R30
...
; 0000 00BE         i1=i;
	MOVW R20,R18
; 0000 00BF     for(j=0;j<4;j++){
	LDI  R17,LOW(0)
_0x1E:
	CPI  R17,4
	BRSH _0x1F
; 0000 00C0         data[j]=i1%10;
	MOV  R30,R17
	LDI  R31,0
	SUBI R30,LOW(-_data)
	SBCI R31,HIGH(-_data)
...
; 0000 00C3 
; 0000 00C4 }
; 0000 00C5 for(j=0;j<10;j++) display();
_0x1A:
	LDI  R17,LOW(0)
_0x21:
	CPI  R17,10
