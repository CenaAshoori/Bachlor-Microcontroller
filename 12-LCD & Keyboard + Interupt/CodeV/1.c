...
unsigned char keyboard(void){
        PORTC = 0b11100000;    
        if(PINC.0==0) { lcd_clear(); }
        if (PINC.1 == 0)return 1;
        if (PINC.2 == 0)return 4;
        if (PINC.3 == 0)return 7;
        PORTC = 0b11010000; 
        if (PINC.0 == 0)return 0;
        if (PINC.1 == 0)return 2;
        if (PINC.2 == 0)return 5;
        if (PINC.3 == 0)return 8;                      
        PORTC = 0b10110000;  
        if(PINC.0==0) { lcd_putchar('='); delay_ms(300); }
        if (PINC.1 == 0)return 3;
        if (PINC.2 == 0)return 6;
        if (PINC.3 == 0)return 9;
        PORTC = 0b01110000;        
        if(PINC.0==0) { lcd_putchar('+'); delay_ms(300); }
        if(PINC.1==0) { lcd_putchar('-'); delay_ms(300); }
        if(PINC.2==0) { lcd_putchar('*'); delay_ms(300); }
        if(PINC.3==0) { lcd_putchar('/'); delay_ms(300); }                      
