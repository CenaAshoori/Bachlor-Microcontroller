...
; 0000 0020 unsigned char keyboard(void){

	.CSEG
_keyboard:
; .FSTART _keyboard
; 0000 0021         PORTC = 0b11100000;
	LDI  R30,LOW(224)
	OUT  0x15,R30
; 0000 0022         if(PINC.0==0) { lcd_clear(); }
	SBIC 0x13,0
	RJMP _0x3
	CALL _lcd_clear
; 0000 0023         if (PINC.1 == 0)return 1;
_0x3:
	SBIC 0x13,1
	RJMP _0x4
	LDI  R30,LOW(1)
	RET
; 0000 0024         if (PINC.2 == 0)return 4;
_0x4:
	SBIC 0x13,2
	RJMP _0x5
	LDI  R30,LOW(4)
	RET
; 0000 0025         if (PINC.3 == 0)return 7;
_0x5:
	SBIC 0x13,3
	RJMP _0x6
	LDI  R30,LOW(7)
	RET
; 0000 0026         PORTC = 0b11010000;
_0x6:
	LDI  R30,LOW(208)
	OUT  0x15,R30
; 0000 0027         if (PINC.0 == 0)return 0;
	SBIC 0x13,0
	RJMP _0x7
	LDI  R30,LOW(0)
	RET
; 0000 0028         if (PINC.1 == 0)return 2;
_0x7:
	SBIC 0x13,1
	RJMP _0x8
	LDI  R30,LOW(2)
	RET
; 0000 0029         if (PINC.2 == 0)return 5;
_0x8:
	SBIC 0x13,2
	RJMP _0x9
	LDI  R30,LOW(5)
	RET
; 0000 002A         if (PINC.3 == 0)return 8;
_0x9:
	SBIC 0x13,3
	RJMP _0xA
	LDI  R30,LOW(8)
	RET
; 0000 002B         PORTC = 0b10110000;
_0xA:
	LDI  R30,LOW(176)
	OUT  0x15,R30
; 0000 002C         if(PINC.0==0) { lcd_putchar('='); delay_ms(300); }
	SBIC 0x13,0
	RJMP _0xB
	LDI  R26,LOW(61)
	CALL SUBOPT_0x0
; 0000 002D         if (PINC.1 == 0)return 3;
_0xB:
	SBIC 0x13,1
	RJMP _0xC
	LDI  R30,LOW(3)
	RET
; 0000 002E         if (PINC.2 == 0)return 6;
_0xC:
	SBIC 0x13,2
	RJMP _0xD
	LDI  R30,LOW(6)
	RET
; 0000 002F         if (PINC.3 == 0)return 9;
_0xD:
	SBIC 0x13,3
	RJMP _0xE
	LDI  R30,LOW(9)
	RET
; 0000 0030         PORTC = 0b01110000;
_0xE:
	LDI  R30,LOW(112)
	OUT  0x15,R30
; 0000 0031         if(PINC.0==0) { lcd_putchar('+'); delay_ms(300); }
	SBIC 0x13,0
	RJMP _0xF
	LDI  R26,LOW(43)
	CALL SUBOPT_0x0
; 0000 0032         if(PINC.1==0) { lcd_putchar('-'); delay_ms(300); }
_0xF:
	SBIC 0x13,1
	RJMP _0x10
	LDI  R26,LOW(45)
	CALL SUBOPT_0x0
; 0000 0033         if(PINC.2==0) { lcd_putchar('*'); delay_ms(300); }
_0x10:
	SBIC 0x13,2
	RJMP _0x11
	LDI  R26,LOW(42)
	CALL SUBOPT_0x0
; 0000 0034         if(PINC.3==0) { lcd_putchar('/'); delay_ms(300); }
_0x11:
	SBIC 0x13,3
	RJMP _0x12
	LDI  R26,LOW(47)
...
; 0000 0042 // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=In Bit2=Out Bit1=Out Bit0=Out
; 0000 0043 DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(255)
	OUT  0x1A,R30
; 0000 0044 // State: Bit7=0 Bit6=0 Bit5=0 Bit4=0 Bit3=T Bit2=0 Bit1=0 Bit0=0
; 0000 0045 PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (0<<PORTA3) | (0<<PORTA2) | (0<<PORTA1) | (0<<PORTA0);
	LDI  R30,LOW(0)
	OUT  0x1B,R30
; 0000 0046 
; 0000 0047 // Port B initialization
; 0000 0048 // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0049 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	OUT  0x17,R30
; 0000 004A // State: Bit7=0 Bit6=0 Bit5=0 Bit4=0 Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 004F DDRC=(1<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	LDI  R30,LOW(240)
	OUT  0x14,R30
