...
; 0000 001C unsigned char keyboard(void){

	.CSEG
_keyboard:
; .FSTART _keyboard
; 0000 001D         PORTB = 0b01110000;
	LDI  R30,LOW(112)
	OUT  0x18,R30
; 0000 001E         if (PINB.1 == 0)return 1;
	SBIC 0x16,1
	RJMP _0x3
	LDI  R30,LOW(1)
	RET
; 0000 001F         if (PINB.2 == 0)return 4;
_0x3:
	SBIC 0x16,2
	RJMP _0x4
	LDI  R30,LOW(4)
	RET
; 0000 0020         if (PINB.3 == 0)return 7;
_0x4:
	SBIC 0x16,3
	RJMP _0x5
	LDI  R30,LOW(7)
	RET
; 0000 0021         PORTB = 0b10110000;
_0x5:
	LDI  R30,LOW(176)
	OUT  0x18,R30
; 0000 0022         if (PINB.0 == 0)return 0;
	SBIC 0x16,0
	RJMP _0x6
	LDI  R30,LOW(0)
	RET
; 0000 0023         if (PINB.1 == 0)return 2;
_0x6:
	SBIC 0x16,1
	RJMP _0x7
	LDI  R30,LOW(2)
	RET
; 0000 0024         if (PINB.2 == 0)return 5;
_0x7:
	SBIC 0x16,2
	RJMP _0x8
	LDI  R30,LOW(5)
	RET
; 0000 0025         if (PINB.3 == 0)return 8;
_0x8:
	SBIC 0x16,3
	RJMP _0x9
	LDI  R30,LOW(8)
	RET
; 0000 0026         PORTB = 0b11010000;
_0x9:
	LDI  R30,LOW(208)
	OUT  0x18,R30
; 0000 0027         if (PINB.1 == 0)return 3;
	SBIC 0x16,1
	RJMP _0xA
	LDI  R30,LOW(3)
	RET
; 0000 0028         if (PINB.2 == 0)return 6;
_0xA:
	SBIC 0x16,2
	RJMP _0xB
	LDI  R30,LOW(6)
	RET
; 0000 0029         if (PINB.3 == 0)return 9;
_0xB:
	SBIC 0x16,3
	RJMP _0xC
	LDI  R30,LOW(9)
	RET
; 0000 002A         else key =10;
_0xC:
	LDI  R30,LOW(10)
	MOV  R5,R30
; 0000 002B     PORTB = 0xf0;
	LDI  R30,LOW(240)
	OUT  0x18,R30
; 0000 002C     return key;
	MOV  R30,R5
	RET
; 0000 002D }
; .FEND
...
; 0000 003A // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 003B DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(240)
	OUT  0x17,R30
; 0000 003C // State: Bit7=0 Bit6=0 Bit5=0 Bit4=0 Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 0046 // Function: Bit7=In Bit6=Out Bit5=Out Bit4=Out Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 0047 DDRD=(0<<DDD7) | (1<<DDD6) | (1<<DDD5) | (1<<DDD4) | (1<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(127)
	OUT  0x11,R30
; 0000 0048 // State: Bit7=T Bit6=0 Bit5=0 Bit4=0 Bit3=0 Bit2=0 Bit1=0 Bit0=0
...
; 0000 009B       key = keyboard();
	RCALL _keyboard
	MOV  R5,R30
; 0000 009C       if(key != 10)PORTD = key;
	LDI  R30,LOW(10)
	CP   R30,R5
	BREQ _0x11
	OUT  0x12,R5
