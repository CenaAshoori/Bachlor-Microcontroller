...
;unsigned char i,Num1,Num2,Num3;
;void main(void)
; 0000 001D {
...
; 0000 008A     Num3=3;
	...
	MOV  R6,R30
; 0000 008B 
; 0000 008C     PORTD=0b00000100;
	LDI  R30,LOW(4)
	OUT  0x12,R30
; 0000 008D     for(i=0; i<=Num1; i++){
	CLR  R5
_0x7:
	CP   R4,R5
	BRLO _0x8
...
_0x8:
; 0000 0090 
; 0000 0091     PORTD=0b00000010;
	LDI  R30,LOW(2)
	OUT  0x12,R30
; 0000 0092     for(i=0; i<=Num3; i++){
	CLR  R5
_0xA:
	CP   R6,R5
	BRLO _0xB
...
_0xB:
; 0000 0095 
; 0000 0096     PORTD=0b00000001;
	LDI  R30,LOW(1)
	OUT  0x12,R30
; 0000 0097     for(i=0; i<=Num2; i++){
	CLR  R5
_0xD:
	CP   R7,R5
	BRLO _0xE
